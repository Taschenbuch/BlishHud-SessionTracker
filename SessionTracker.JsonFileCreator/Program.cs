...
namespace SessionTracker.JsonFileCreator
{
    internal class Program
    {
        ...
        {
            new Entry { Id = EntryId.DEATHS, LabelText                = "Deaths", LabelTooltip              = "Deaths\nCombined deaths from all sources like WvW, sPvP, PvE", PlaceholderInTooltip = "deaths", IconFileName          = "death.png" },
            ...
            new Entry { Id = "wvw supply spent on repairs", LabelText = "Supply (repair)", LabelTooltip     = "Supply spent on repairs", PlaceholderInTooltip                                      = "supplies", AchievementId       = 306, IconFileName = "supplySpend.png" },
            new Entry { Id = "wvw dolyaks killed", LabelText          = "Dolyaks killed", LabelTooltip      = "Dolyaks killed", PlaceholderInTooltip                                               = "dolyaks", AchievementId        = 288, IconFileName = "dolyak.png" },
            new Entry { Id = "wvw dolyaks escorted", LabelText        = "Dolyaks escorted", LabelTooltip    = "Dolyaks escorted", PlaceholderInTooltip                                             = "dolyaks", AchievementId        = 285, IconFileName = "dolyakDefended.png" },
            new Entry { Id = "wvw camps captured", LabelText          = "Camps captured", LabelTooltip      = "Supply camp captured", PlaceholderInTooltip                                         = "camps", AchievementId          = 291, IconFileName = "camp.png" },
            new Entry { Id = "wvw camps defended", LabelText          = "Camps defended", LabelTooltip      = "Supply camps defended", PlaceholderInTooltip                                        = "camps", AchievementId          = 310, IconFileName = "campDefended.png" },
            new Entry { Id = "wvw towers captured", LabelText         = "Towers captured", LabelTooltip     = "Towers captured", PlaceholderInTooltip                                              = "towers", AchievementId         = 297, IconFileName = "tower.png" },
            new Entry { Id = "wvw towers defended", LabelText         = "Towers defended", LabelTooltip     = "Towers defended", PlaceholderInTooltip                                              = "towers", AchievementId         = 322, IconFileName = "towerDefended.png" },
            new Entry { Id = "wvw keeps captured", LabelText          = "Keeps captured", LabelTooltip      = "Keeps captured", PlaceholderInTooltip                                               = "keeps", AchievementId          = 300, IconFileName = "keep.png" },
            new Entry { Id = "wvw keeps defended", LabelText          = "Keeps defended", LabelTooltip      = "Keeps defended", PlaceholderInTooltip                                               = "keeps", AchievementId          = 316, IconFileName = "keepDefended.png" },
            new Entry { Id = "wvw castles captured", LabelText        = "Castles captured", LabelTooltip    = "Stonemist castles captured", PlaceholderInTooltip                                   = "castles", AchievementId        = 294, IconFileName = "castle.png" },
            new Entry { Id = "wvw castles defended", LabelText        = "Castles defended", LabelTooltip    = "Stonemist castles defended", PlaceholderInTooltip                                   = "castles", AchievementId        = 313, IconFileName = "castleDefended.png" },
            new Entry { Id = "wvw objectives captured", LabelText     = "Objectives captured", LabelTooltip = "Objectives captured", PlaceholderInTooltip                                          = "objectives", AchievementId     = 303, IconFileName = "objective.png" },
            new Entry { Id = "wvw objectives defended", LabelText     = "Objectives defended", LabelTooltip = "Objectives defended", PlaceholderInTooltip                                          = "objectives", AchievementId     = 319, IconFileName = "objectiveDefended.png" },
        };
    }
}