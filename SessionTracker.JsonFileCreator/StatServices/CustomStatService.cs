...
namespace SessionTracker.JsonFileCreator.StatServices
{
    ...
    {
        public static readonly List<Stat> CustomStats = new List<Stat>
        {
            new Stat { Id = StatId.LUCK, Name = { LocalizedTextByLocale = { [Locale.English] = "Luck", [Locale.German] = "Glück", [Locale.French] = "Chance", [Locale.Spanish] = "Suerte" } }, IconFileName = "luck.png" },
            new Stat
            {
                Id           = StatId.DEATHS,
            ...
            new Stat { Id = StatId.PVP_KILLS, Name = { LocalizedTextByLocale = { [Locale.English] = "PvP kills", [Locale.German] = "PvP Feinde besiegt", [Locale.French] = "Victimes JcJ", [Locale.Spanish] = "PvP bajas" } }, IconFileName = "kill.png", ApiId = 239, ApiIdType = ApiIdType.Achievement },
            new Stat
            {
                Id           = StatId.PVP_KDR,
            ...
            new Stat { Id = StatId.WVW_KILLS, Name           = { LocalizedTextByLocale = { [Locale.English] = "WvW kills", [Locale.German]           = "WvW Feinde besiegt", [Locale.French]            = "Victimes McM", [Locale.Spanish]               = "McM Bajas" } }, IconFileName                        = "kill.png", ApiId = 283, ApiIdType = ApiIdType.Achievement },
            new Stat
            {
                Id           = StatId.WVW_KDR,
                IconFileName = "kdr.png",
            ...
            new Stat { Id = StatId.WVW_RANK, Name = { LocalizedTextByLocale = { [Locale.English] = "WvW rank", [Locale.German] = "WvW rang", [Locale.French] = "Rang McM", [Locale.Spanish] = "McM Rango" } }, IconFileName = "wvwRank.png" },
            new Stat
            {
            ...
            new Stat { Id = "wvw dolyaks killed", Name      = { LocalizedTextByLocale = { [Locale.English] = "Dolyaks killed", [Locale.German]      = "Karawane besiegt", [Locale.French]    = "Caravanes tuées", [Locale.Spanish]     = "Caravanas asesinadas" } }, IconFileName   = "dolyak.png", ApiId            = 288, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw dolyaks escorted", Name    = { LocalizedTextByLocale = { [Locale.English] = "Dolyaks escorted", [Locale.German]    = "Karawane verteidgt", [Locale.French]  = "Caravanes escortées", [Locale.Spanish] = "Caravanas escoltadas" } }, IconFileName   = "dolyakDefended.png", ApiId    = 285, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw camps captured", Name      = { LocalizedTextByLocale = { [Locale.English] = "Camps captured", [Locale.German]      = "Lager erobert", [Locale.French]       = "Camps capturés", [Locale.Spanish]      = "Campamentos capturados" } }, IconFileName = "camp.png", ApiId              = 291, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw camps defended", Name      = { LocalizedTextByLocale = { [Locale.English] = "Camps defended", [Locale.German]      = "Lager verteidigt", [Locale.French]    = "Camps défendus", [Locale.Spanish]      = "Campamentos defendidos" } }, IconFileName = "campDefended.png", ApiId      = 310, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw towers captured", Name     = { LocalizedTextByLocale = { [Locale.English] = "Towers captured", [Locale.German]     = "Türme erobert", [Locale.French]       = "Tours capturées", [Locale.Spanish]     = "Torres capturadas" } }, IconFileName      = "tower.png", ApiId             = 297, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw towers defended", Name     = { LocalizedTextByLocale = { [Locale.English] = "Towers defended", [Locale.German]     = "Türme verteidigt", [Locale.French]    = "Tours défendues", [Locale.Spanish]     = "Torres defendidas" } }, IconFileName      = "towerDefended.png", ApiId     = 322, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw keeps captured", Name      = { LocalizedTextByLocale = { [Locale.English] = "Keeps captured", [Locale.German]      = "Festungen erobert", [Locale.French]   = "Forts capturés", [Locale.Spanish]      = "Fortalezas capturadas" } }, IconFileName  = "keep.png", ApiId              = 300, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw keeps defended", Name      = { LocalizedTextByLocale = { [Locale.English] = "Keeps defended", [Locale.German]      = "Festungen verteidgt", [Locale.French] = "Forts défendus", [Locale.Spanish]      = "Fortalezas defendidas" } }, IconFileName  = "keepDefended.png", ApiId      = 316, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw castles captured", Name    = { LocalizedTextByLocale = { [Locale.English] = "Castles captured", [Locale.German]    = "Schloss erobert", [Locale.French]     = "Châteaux capturés", [Locale.Spanish]   = "Castillos capturados" } }, IconFileName   = "castle.png", ApiId            = 294, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw castles defended", Name    = { LocalizedTextByLocale = { [Locale.English] = "Castles defended", [Locale.German]    = "Schloss verteidgt", [Locale.French]   = "Châteaux défendus", [Locale.Spanish]   = "Castillos defendidos" } }, IconFileName   = "castleDefended.png", ApiId    = 313, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw objectives captured", Name = { LocalizedTextByLocale = { [Locale.English] = "Objectives captured", [Locale.German] = "Objekte erobert", [Locale.French]     = "Objectifs capturés", [Locale.Spanish]  = "Objetivos capturados" } }, IconFileName   = "objective.png", ApiId         = 303, ApiIdType = ApiIdType.Achievement },
            new Stat { Id = "wvw objectives defended", Name = { LocalizedTextByLocale = { [Locale.English] = "Objectives defended", [Locale.German] = "Objekte verteidigt", [Locale.French]  = "Objectifs défendus", [Locale.Spanish]  = "Objetivos defendidos" } }, IconFileName   = "objectiveDefended.png", ApiId = 319, ApiIdType = ApiIdType.Achievement },
        };
    }
}