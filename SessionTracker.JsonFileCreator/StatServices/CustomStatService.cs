...
namespace SessionTracker.JsonFileCreator.StatServices
{
    public class CustomStatService
    {
        public static readonly List<Entry> CustomStats = new List<Entry>
        {
            ...
            new Entry { Id = EntryId.PVP_RANKING_POINTS, Name  = { LocalizedTextByLocale = { [Locale.English] = "PvP ranking points", [Locale.German]  = "PvP Rangpunkte", [Locale.French]                = "Points de classement JcJ", [Locale.Spanish]   = "PvP Puntos de clasificación" } }, IconFileName      = "pvpRankingPoints.png" },
