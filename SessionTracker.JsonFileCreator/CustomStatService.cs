    ...
    public class CustomStatService
    {
        public static readonly List<Entry> CustomStats = new List<Entry>
        {
            ...
            new Entry
            {
                ...
                LabelText    = { LocalizedTextByLocale = { [Locale.English] = "PvP KDR", [Locale.German]                = "PvP KDR", [Locale.French]                             = "KDR JcJ", [Locale.Spanish]                  = "PvP B/M" } },
                LabelTooltip = { LocalizedTextByLocale = { [Locale.English] = "PvP kills/deaths ratio", [Locale.German] = "PvP Verhältnis besiegte Feinde/Tode", [Locale.French] = "Ratio Victimes/Morts JcJ", [Locale.Spanish] = "PvP Ratio de Bajas/Muertes" } }
            },
            ...
            new Entry
            {
                Id           = EntryId.WVW_KDR,
                IconFileName = "kdr.png",
                LabelText    = { LocalizedTextByLocale = { [Locale.English] = "WvW KDR", [Locale.German]                = "WvW KDR", [Locale.French]                             = "KDR McM", [Locale.Spanish]                     = "McM B/M" } },
                LabelTooltip = { LocalizedTextByLocale = { [Locale.English] = "WvW kills/deaths ratio", [Locale.German] = "WvW Verhältnis besiegte Feinde/Tode", [Locale.French] = "Ratio Victimes/Morts en McM", [Locale.Spanish] = "McM Ratio de Bajas/Muertes" } }
            },
            ...
            new Entry
            {
                ...
                LabelText    = { LocalizedTextByLocale = { [Locale.English] = "Supply (repair)", [Locale.German]         = "Vorräte (reparieren)", [Locale.French]                 = "Ravitaillement (réparations)", [Locale.Spanish]                            = "Suministros (reparaciones)" } }, IconFileName = "supplySpend.png",
                LabelTooltip = { LocalizedTextByLocale = { [Locale.English] = "Supply spent on repairs", [Locale.German] = "Durch Reparieren verbrauchte Vorräte", [Locale.French] = "Quantité de ravitaillement utilisé pour les réparations", [Locale.Spanish] = "Suministros gastados en reparaciones" } }
            },
