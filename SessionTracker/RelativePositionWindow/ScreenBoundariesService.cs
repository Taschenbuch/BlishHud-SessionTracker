...
namespace SessionTracker.RelativePositionWindow
{
    ...
    {
        public static Point AdjustLocationToKeepContainerInsideScreenBoundaries(Point coordinates, Point containerSize, Point screenSize)
        {
            var x = AdjustCoordinateToKeepContainerInsideScreenBoundaries(coordinates.X, containerSize.X, screenSize.X);
            var y = AdjustCoordinateToKeepContainerInsideScreenBoundaries(coordinates.Y, containerSize.Y, screenSize.Y);
